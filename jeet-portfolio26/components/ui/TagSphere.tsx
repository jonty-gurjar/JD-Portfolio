...
function normalizeTags(tags: TagSphereTag[]) {
...
export default function TagSphere({
  ...
  return (
    <div
      className={`relative w-full overflow-visible bg-transparent font-[inherit] text-[#f4f1ea] isolate${className ? ` ${className}` : ''}`}
      style={rootStyle}
    >
